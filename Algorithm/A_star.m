input_map = false(100);              % Create an Input Map
input_map (30:90, 50:70) = 1;           % Add an obstacle
start_coords = [60, 10];              % Save the location of start coordinate
dest_coords = [80, 90];               % Save location of destination coordinate
